            ...
            <div class="tab-content">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <h4><?php echo  isset($model) ? 'Edit' : 'Add' ?> Products </h4>
                        <!-- end of view-info -->
                        <div class="edit-info">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="general-info">
                                        <form  action="<?php echo  base_url('index.php/admin/products/store') ?>" method="post" id="edit_cms" >
                                            <input type="hidden" name="cid" value="<?php echo  isset($model) ? $model->products_id : '' ?>" />
                                            <div class="row">
                                                <div class="col-lg-6" style="">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <label for="name" class="block"><stong>Products Title *</stong></label>
                                                        </div>
                                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <?php if (isset($model->thumbnail) && !empty($model->thumbnail)): ?>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <image src="<?php echo site_url() . 'uploads/products/original/' . $model->thumbnail ?>" style="max-height: 150px;"/>
                                                            </div>
                                                            <span class="help-block col-sm-12"></span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="text-center">
                                                <a id="back_btn" style="display:none;" href="<?php echo  base_url('index.php/admin/products') ?>" class="btn btn-dark waves-effect waves-light m-r-20">Back</a>
