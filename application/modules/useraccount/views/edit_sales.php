            ...
            <div class="dash-frm-wrap" style="margin-bottom: 50px;">
                  <div class="row"><span class="alert alert-success" style="display:none;width:95%"></span></div>
                    ...
                    <div class="form-group">
                        <?php echo $sales_detail->purchaser_org_name;?>
                    </div>
                  </div>
                        <div class="col-md-4"> 
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" colspan="4"><?php echo $sales_detail->total_price;?></td>
                                </tr>
                                <tr>
                                    <td class="text-right" colspan="4">Total Paid=</td>
                                    <td class="text-center" colspan="4"><?php echo $sales_detail->paid;?></td>
                                </tr>
                                <tr>
                                    <td class="text-right" colspan="4">Dues=</td>
                                    <td class="text-center" colspan="4"><?php echo $sales_detail->dues;?></td>
                                </tr>
                            </tbody>
                          </table>
                        </div>
                ...
                <div class="form-group mt-3 float-right">
                    <?php if($sales_detail->order_status==ORDER_CREATED){?>
<!--                        In Process-->
<button type="submit" onclick="confirmInvoice('1');"> Accept</button> <button type="submit" onclick="confirmInvoice('0');"> Reject</button>
                  ...
                  <form action="<?php echo base_url('useraccount/add-payment')?>" id="do-add-payment-form" method="post">
                      <input type="hidden" name="is_receive" value="1" />
                      <input type="hidden" name="invoice_id" value="<?php echo $sales_detail->sale_id;?>" />
                  <div class="row">
                      <div class="col-md-1">
                          <div class="form-group">
                              <label for="exampleInputEmail1">Dues Total</label>
                              <input class="form-control" type="text" id="grand_total" value="<?php echo $sales_detail->dues;?>" name="grand_total" disabled="disabled" />
...
$('.datepicker').datepicker({
    ...
    function confirmInvoice(isApproved){
        var url = '<?php echo base_url('useraccount/confirmSales');?>';
        var data = new FormData();
        data.append('sale_id', '<?php echo $sales_detail->sale_id;?>');
