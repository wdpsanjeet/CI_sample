        ...
        <div class="rgt_tophead">
          ...
          <div class="rgt-sidebar-body">
            ...
            <div class="dash-frm-wrap" style="margin-bottom: 50px;">
              <form action="<?php echo base_url('useraccount/do-add-sales')?>" id="do-add-order-form" method="post">
                ...
                <div class="form-group mt-3 float-right">
                  <button type="submit"><?php echo  isset($model) ? 'Update' : 'Add' ?> Sale</button>
                </div>
              </form>
            </div>
          </div>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp.status === 200) {
                    $("#client_org_id").append(resp.FavHTMLOpt);
                    $("#addDeliveriesModel").find(".close").trigger('click');
